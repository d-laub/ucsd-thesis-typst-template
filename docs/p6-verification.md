...
| example-3.png | iii | p. 18 (non-joint) | no header; approval statement left-justified at top; "University of California San Diego" + "2026" centered below; "iii" at bottom; matches manual non-joint sample p.18 — statement upper area, university/year lower-middle, blank bottom, content span centered ~48% | pass |
